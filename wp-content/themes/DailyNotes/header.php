    ...
    <div id="wrapper2">
        <div id="content">
			...
			if ($primaryNav == '') { ?>
				<ul class="<?php echo $menuClass; ?>">
					<?php if (get_option('dailynotes_home_link') == 'on') { ?>
						<li class="page_item<?php if(is_home()) echo(' current_page_item'); ?>"><a href="<?php bloginfo('url'); ?>"><?php _e('Home','DailyNotes') ?></a></li>
					<?php }; ?>
            ...
            <div id="search-wrap">
                ...
                <img id="search" src="<?php bloginfo('template_directory'); ?>/images/<?php echo($colorSchemePath); ?>search.gif" alt="search" />
                <div id="search-form">
                    <form method="get" id="searchform" action="<?php bloginfo('url'); ?>">
                        <input type="text" value="<?php _e('search this site...','DailyNotes'); ?>" name="s" id="searchinput" />
                    </form>
                </div>
            </div>
            <br class="clear" />