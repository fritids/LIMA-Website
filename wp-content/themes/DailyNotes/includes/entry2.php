...
<div class="big_post" id="post_<?php echo $i; ?>">
	...
	<img class="next" src="<?php bloginfo('template_directory'); ?>/images/<?php echo($colorSchemePath); ?>arrow.gif" alt="next page" />
	<img class="previous" src="<?php bloginfo('template_directory'); ?>/images/<?php echo($colorSchemePath); ?>previous.gif" alt="next page" />
	...
	<div class="post_info">
		<div class="inner-div">
			...
			<span class="comments"><?php comments_popup_link(__('0 comments','DailyNotes'), __('1 comment','DailyNotes'), '% '.__('comments','DailyNotes')); ?></span>
			<span class="readmore">
				<?php if ($postType == 'link') { ?>
					<span><a href="<?php echo $link ?>"><?php _e('visit url »','DailyNotes'); ?></a></span>
				<?php } else { ?>
					<span><a href="<?php the_permalink(); ?>"><?php _e('full post »','DailyNotes'); ?></a></span>
				<?php }; ?>
			</span>
		</div>
	</div>
	...
	<?php if ($postType == 'photo') { ?>   
		...
		<div class="black">
			<a class="lightbox" href="<?php echo $thumbnail["fullpath"]; ?>"><img src="<?php bloginfo('template_directory'); ?>/images/shadow-overlay.png" alt="thumbnail" style="position: absolute; top: 0; left: 0; border: none;" /></a>
