...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#categories li a, .current_page_item a, .home-link a { color: #<?php echo(get_option($shortname.'_color_catlink')); ?> !important; }
		...
		.titles2 a, .titles a { color:#<?php echo(get_option($shortname.'_color_recentheadings')); ?> !important; }
