<div id="container"> <img src="<?php bloginfo('template_directory'); ?>/images/content-top-home.gif" alt="logo" style="float: left;" />
    <div id="left-div">
        <!--Begind recent post-->
<?php if (is_home()) {
...
<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
    ...
    <?php get_sidebar(); ?>
    <img src="<?php bloginfo('template_directory'); ?>/images/content-bottom.gif" alt="logo" style="float: left;" /> </div>